package com.example.lesson_8_lukin.presentation.addNoteWindow
...
class addNoteWindowFragment : Fragment(R.layout.fragment_second) {
    ...
    companion object {
        ...
        const val NOTE = "note"
        fun newInstance(noteEntity: NoteEntity): addNoteWindowFragment {
            return addNoteWindowFragment().apply { arguments = bundleOf(NOTE to noteEntity) }
        }
    }

    private val binding by viewBinding(FragmentSecondBinding::bind)

    private val viewModel: addNoteWindowViewModel by viewModels()
